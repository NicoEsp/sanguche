...
export const SEO_ROUTES: Record<string, SeoRouteData> = {
  ...
  '/soy-dev': {
    ...
    jsonLd: [
      ...
      },
      {
        ...
        // Apunta a la landing pública, no a /autoevaluacion: esa está detrás de
        // ProtectedRoute y se sirve noindex, así que el structured data se
        // perdía en una URL que Google no va a indexar.
        url: `${SITE_URL}/evaluacion-product-manager`,
        inLanguage: 'es',
  ...
  // Catálogo canónico de recursos. /preguntas 301ea acá, así que sus términos
