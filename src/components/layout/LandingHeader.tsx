  ...
  return (
    <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur animate-fade-in">
      <div className="container flex h-14 items-center justify-between gap-4">
        ...
        {/* Center: NicoProducto — sólo desde xl, en lg no entra junto a la nav */}
        ...
        <div className="hidden sm:flex items-center gap-3 shrink-0">
          {/* Entre lg y xl la nav ocupa el centro y el bloque de NicoProducto
              está oculto: sin esto, X y LinkedIn no serían alcanzables en ese
              rango (el hamburguesa tampoco se muestra). */}
