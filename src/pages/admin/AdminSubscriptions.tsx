...
function SubscriptionsTable() {
  ...
  const getPlanBadge = (plan: string, isComped: boolean) => {
    const planBadges: Record<string, { className: string; label: string }> = {
      ...
      productprepa_business: { className: 'bg-indigo-500/20 text-indigo-600 border-indigo-500/30', label: 'PP Business' },
      productastic_review: { className: 'bg-emerald-500/20 text-emerald-600 border-emerald-500/30', label: 'Review' },
      ...
      <div className="flex flex-wrap gap-4">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="productastic_review">Productastic Review</SelectItem>
