...
const buildInitialObjectives = (): ProgressObjective[] => [
  {
    ...
    source: "suggested",
    steps: [
      { id: "s-1-1", title: "Revisar framework de product discovery", completed: true },
      { id: "s-1-2", title: "Planificar entrevistas quincenales", completed: false },
      { id: "s-1-3", title: "Documentar aprendizajes en Notion", completed: false },
    ],
    level: { current: 2, target: 4, label: "Confianza" },
  ...
  },
  {
    ...
    source: "suggested",
    steps: [
      { id: "s-2-1", title: "Mapear métricas actuales", completed: false },
      { id: "s-2-2", title: "Identificar leading indicators", completed: false },
      { id: "s-2-3", title: "Alinear definición con stakeholders", completed: false },
    ],
    level: { current: 1, target: 3, label: "Dominio" },
    dueDate: undefined,
    status: "not-started",
    timeframe: "soon",
  },
  {
    ...
    source: "mentor",
    steps: [
      { id: "m-1-1", title: "Diseñar agenda colaborativa", completed: false },
      { id: "m-1-2", title: "Preparar dinámicas de decisión", completed: false },
      { id: "m-1-3", title: "Documentar próximos pasos", completed: false },
    ],
    mentorNotes:
      "Recuerda apoyarte en ejemplos concretos y reservar 10 minutos finales para definir owners.",
    status: "in-progress",
  ...
  },
  {
    ...
    source: "mentor",
    steps: [
      { id: "m-2-1", title: "Definir objetivos de acompañamiento", completed: false },
      { id: "m-2-2", title: "Establecer ritual de feedback", completed: false },
    ],
...
export default function Progress() {
  ...
  const completionRate = objectivesInCanvas.length
    ? Math.round((completedObjectives.length / objectivesInCanvas.length) * 100)
    : 0;
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground max-w-2xl">
                  Arrastra objetivos sugeridos por ProductPrepa o creados en mentorías para dar forma a tu Career Path.
                  Agrúpalos por horizonte temporal y hacé seguimiento del avance paso a paso.
                </p>
              </div>
                ...
                <div className="grid md:grid-cols-3">
                  {STAGES.map((stage) => (
                    <div
                      ...
                      className={cn(
                        "relative p-6 md:p-8 border-t md:border-t-0 md:border-l",
                        ...
                        {canvas[stage.key].map((id, index) => {
                          ...
                          return (
                            <div
                              key={id}
                              className={cn(
                                "relative rounded-2xl border bg-background/80 backdrop-blur p-5 shadow-sm",
                            ...
                            >
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {objective.source === "mentor" ? (
                                      ...
                                      <Badge variant="secondary" className="text-xs">{objective.source === "custom" ? "Personal" : "Sugerido"}</Badge>
                                    )}
                                  </div>
                                ...
                                <div className="flex flex-col items-end gap-2">
                                  ...
                                  {objective.source !== "mentor" && (
                                    <Button
                                      ...
                                      onClick={() => removeFromCanvas(stage.key, id)}
                                    ...
                                    {objective.steps.map((step) => (
                                      <label
                                        ...
                                        className={cn(
                                          ...
                                          objective.source === "mentor" && "cursor-default"
                                        )}
                                      >
                                        <Checkbox
                                          checked={step.completed}
                                          onCheckedChange={() => toggleStep(objective.id, step.id)}
                                          disabled={objective.source === "mentor" && step.completed}
                                          className="mt-0.5"
                                        />
                              ...
                              {index < canvas[stage.key].length - 1 && (
                                <div className="absolute left-1/2 bottom-0 translate-y-1/2 -translate-x-1/2 w-px h-8 bg-gradient-to-b from-transparent via-primary/20 to-transparent" />
                              )}
                            </div>
                          );
                        })}
          ...
          <section className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        onChange={(event) =>
                          setCustomState((prev) => ({ ...prev, title: event.target.value }))
                        }
                    ...
                    <div className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        onChange={(event) =>
                          setCustomState((prev) => ({ ...prev, summary: event.target.value }))
                        }
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          onChange={(event) =>
                            setCustomState((prev) => ({ ...prev, type: event.target.value }))
                          }
                        />
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value: CanvasStage) =>
                            setCustomState((prev) => ({ ...prev, timeframe: value }))
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        onChange={(event) =>
                          setCustomState((prev) => ({ ...prev, dueDate: event.target.value }))
                        }
                      />
                    </div>
                    <div className="grid gap-2">
                      ...
                      <Textarea
                        ...
                        onChange={(event) =>
                          setCustomState((prev) => ({ ...prev, stepsText: event.target.value }))
                        }
                    ...
                    <Button
                      ...
                      disabled={!customState.title.trim()}
                    >
                      Guardar objetivo
                    </Button>
                  </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              <ObjectiveColumn
                ...
                objectives={objectives.filter((objective) => objective.source === "suggested")}
              ...
              <ObjectiveColumn
                ...
                description="Objetivos acordados junto a tu mentor. Se mantienen bloqueados."
                objectives={objectives.filter((objective) => objective.source === "mentor")}
                onDragStart={handleDragStart}
                onDragEnd={handleDragEnd}
                draggingId={draggingId}
                locked
              ...
              <ObjectiveColumn
                ...
                objectives={objectives.filter((objective) => objective.source === "custom")}
                onDragStart={handleDragStart}
                onDragEnd={handleDragEnd}
                draggingId={draggingId}
                onDelete={deleteCustomObjective}
              />
            </div>
          </section>
        </div>
            ...
            {objectives.map((objective) => (
              ...
              >
                ...
                <div className="mt-3 flex flex-wrap gap-2 text-xs text-muted-foreground">
                  ...
                  {objective.dueDate && (
                    <Badge variant="outline">{formatDueDate(objective.dueDate)}</Badge>
                  )}
                </div>
              </div>
            ))}
