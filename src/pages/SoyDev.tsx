...
type WhyCard = {
  ...
  assessmentCta?: { tipo: AssessmentTypeKey; label: string; ctaLocation: string };
};
...
const whyCards: ReadonlyArray<WhyCard> = [
  ...
  },
  {
    ...
    assessmentCta: {
      ...
      ctaLocation: "soy_dev_side_projects",
    },
  },
];
...
const blogSlug = (to: string) => to.replace(/^\/blog\//, "");
...
const SoyDev = () => {
  ...
  const handleAssessmentClick = (tipo: AssessmentTypeKey, ctaLocation: string) => {
    try {
    ...
    trackEvent("landing_page_cta_click", { cta_location: ctaLocation, assessment_type: tipo });
  };
        ...
        <section className="container py-12 sm:py-20 px-4 sm:px-6 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <Link
                ...
                onClick={() => handleAssessmentClick("sin_experiencia", "soy_dev_hero")}
              >
          ...
          <p className="mt-4 text-center text-sm text-muted-foreground">
            <Link
              ...
              onClick={() => handleAssessmentClick("experimentado", "soy_dev_ya_trabajo")}
                ...
                >
                  <CardContent className="p-6 flex flex-col h-full">
                    ...
                    <Link
                      to={card.link.to}
                      onClick={() =>
                        trackEvent("soy_dev_articulo_clicked", { slug: blogSlug(card.link.to) })
                      }
                    ...
                    {cta && (
                      <Button asChild variant="outline" size="sm" className="mt-4 w-full sm:w-auto sm:self-start">
                        <Link
                          ...
                          onClick={() => handleAssessmentClick(cta.tipo, cta.ctaLocation)}
                        >
                          {cta.label}
          ...
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              ...
              <Link
                ...
                state={{ from: "/soy-dev" }}
                onClick={() =>
                  trackEvent("landing_page_cta_click", { cta_location: "soy_dev_planes_inline" })
                }
            ...
            <CardContent className="p-8 sm:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  <Link
                    {...assessmentLink("sin_experiencia")}
                    onClick={() => handleAssessmentClick("sin_experiencia", "soy_dev_final")}
                  >
                    Comenzar evaluación gratis
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                ...
                <Button asChild variant="ghost" size="lg">
                  <Link
                    ...
                    state={{ from: "/soy-dev" }}
                    onClick={() =>
                      trackEvent("landing_page_cta_click", { cta_location: "soy_dev_planes" })
                    }
                  >
                    Ver planes
                    <ArrowRight className="ml-2 h-4 w-4" />
